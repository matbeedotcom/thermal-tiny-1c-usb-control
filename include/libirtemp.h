...
#define IRTEMP_ERROR(format, ...) irtemp_error_print("libirtemp error [%s:%d/%s] " format "\n", \
    ...
    * @param[in] org_temp The origin temperature of target(celcius temperature, unit:��)
    * @param[out] new_temp The new temperature after correct(celcius temperature, unit:��)
    *
    * @return see irtemp_error_t
    */
